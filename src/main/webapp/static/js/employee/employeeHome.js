(function () {
	...
	function prepareTableRequest(tableBodyselector) {
		...
		const url = "http://localhost:8080/expense-reimbursment-system/api/reimbursements";
		let columnMap;
		let rowLimit;
		let pageNumber;
	...
	function submitReimbursement(e) {
		...
		let url = `http://localhost:8080/expense-reimbursment-system/api/reimbursements`;
